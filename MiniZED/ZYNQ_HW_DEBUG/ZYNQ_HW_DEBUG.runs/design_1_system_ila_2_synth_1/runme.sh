...
HD_PWD='D:/FPGA/ZYNQ_HW_DEBUG/ZYNQ_HW_DEBUG.runs/design_1_system_ila_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_system_ila_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_system_ila_2.tcl
