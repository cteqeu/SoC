...
HD_PWD='D:/FPGA/MATH_IP_APP/MATH_IP_APP.runs/design_1_AXI_MATH_UNIT_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXI_MATH_UNIT_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXI_MATH_UNIT_0_0.tcl
