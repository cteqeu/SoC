...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set getal2_0 [ create_bd_port -dir I -from 3 -to 0 getal2_0 ]
  set resultaat_0 [ create_bd_port -dir O -from 3 -to 0 resultaat_0 ]

  # Create instance: eFPGA_AXI_Core1_0, and set properties
  set eFPGA_AXI_Core1_0 [ create_bd_cell -type ip -vlnv PXL.LOCAL:user:eFPGA_AXI_Core1:1.0 eFPGA_AXI_Core1_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins eFPGA_AXI_Core1_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net eFPGA_AXI_Core1_0_resultaat [get_bd_ports resultaat_0] [get_bd_pins eFPGA_AXI_Core1_0/resultaat]
  connect_bd_net -net getal2_0_1 [get_bd_ports getal2_0] [get_bd_pins eFPGA_AXI_Core1_0/getal2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins eFPGA_AXI_Core1_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins eFPGA_AXI_Core1_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs eFPGA_AXI_Core1_0/S00_AXI/S00_AXI_reg] -force
