...
proc create_root_design { parentCell } {
  ...
  set dobbelsteen_0 [ create_bd_cell -type ip -vlnv cteq.eu:user:dobbelsteen:1.0 dobbelsteen_0 ]
  ...
  connect_bd_net -net dobbelsteen_0_je [get_bd_ports je_0] [get_bd_pins dobbelsteen_0/je]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins dobbelsteen_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
