...
HD_PWD='C:/devWorks/Vitis_Custom_AXI_IP/Vitis_Custom_AXI_IP.runs/design_1_Math_IP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Math_IP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Math_IP_0_0.tcl
