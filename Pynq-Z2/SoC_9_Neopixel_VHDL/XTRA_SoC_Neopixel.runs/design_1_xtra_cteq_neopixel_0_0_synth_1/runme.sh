...
HD_PWD='C:/Users/20002890/XTRA_SoC_Neopixel/XTRA_SoC_Neopixel.runs/design_1_xtra_cteq_neopixel_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xtra_cteq_neopixel_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xtra_cteq_neopixel_0_0.tcl
