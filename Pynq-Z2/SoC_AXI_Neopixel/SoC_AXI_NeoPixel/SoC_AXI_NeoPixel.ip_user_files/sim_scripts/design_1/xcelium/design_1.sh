...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../SoC_AXI_NeoPixel.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../SoC_AXI_NeoPixel.gen/sources_1/bd/design_1/ipshared/3007/hdl" \
       +incdir+"../../../../SoC_AXI_NeoPixel.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../SoC_AXI_NeoPixel.gen/sources_1/bd/design_1/ipshared/3007/hdl" \
