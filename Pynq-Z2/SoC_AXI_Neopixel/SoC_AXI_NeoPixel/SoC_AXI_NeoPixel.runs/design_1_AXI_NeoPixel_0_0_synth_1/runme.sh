...
HD_PWD='C:/devWorks/SoC_Neopixel_VHDL/SoC_AXI_NeoPixel/SoC_AXI_NeoPixel.runs/design_1_AXI_NeoPixel_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AXI_NeoPixel_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AXI_NeoPixel_0_0.tcl
