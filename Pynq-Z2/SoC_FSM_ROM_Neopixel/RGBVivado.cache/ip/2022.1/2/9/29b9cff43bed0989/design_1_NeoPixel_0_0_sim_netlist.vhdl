...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_NeoPixel is
  ...
  signal \delay_low_cntr_reg[5]_i_3_n_0\ : STD_LOGIC;
  signal \delay_low_cntr_reg[5]_i_3_n_1\ : STD_LOGIC;
  signal \delay_low_cntr_reg[5]_i_3_n_2\ : STD_LOGIC;
  signal \delay_low_cntr_reg[5]_i_3_n_3\ : STD_LOGIC;
  ...
  attribute ADDER_THRESHOLD of \delay_low_cntr_reg[5]_i_3\ : label is 35;
...
\delay_low_cntr[5]_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\delay_low_cntr_reg[5]_i_3\: unisim.vcomponents.CARRY4
     port map (
      CI => \delay_low_cntr_reg[2]_i_1_n_0\,
      CO(3) => \delay_low_cntr_reg[5]_i_3_n_0\,
      CO(2) => \delay_low_cntr_reg[5]_i_3_n_1\,
      CO(1) => \delay_low_cntr_reg[5]_i_3_n_2\,
      CO(0) => \delay_low_cntr_reg[5]_i_3_n_3\,
      CYINIT => '0',
      ...
      S(3) => \delay_low_cntr[5]_i_4_n_0\,
      S(2) => \delay_low_cntr[5]_i_5_n_0\,
      S(1) => \delay_low_cntr[5]_i_6_n_0\,
      S(0) => \delay_low_cntr[5]_i_7_n_0\
    );
