...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_NeoPixel is
  ...
  signal \delay_high_cntr[5]_i_29_n_0\ : STD_LOGIC;
  ...
  signal \delay_high_cntr_reg[5]_i_5_n_1\ : STD_LOGIC;
  signal \delay_high_cntr_reg[5]_i_5_n_2\ : STD_LOGIC;
  signal \delay_high_cntr_reg[5]_i_5_n_3\ : STD_LOGIC;
  signal \delay_high_cntr_reg[5]_i_5_n_4\ : STD_LOGIC;
  signal \delay_high_cntr_reg[5]_i_5_n_5\ : STD_LOGIC;
  signal \delay_high_cntr_reg[5]_i_5_n_6\ : STD_LOGIC;
  signal \delay_high_cntr_reg[5]_i_5_n_7\ : STD_LOGIC;
  ...
  signal \NLW_delay_high_cntr_reg[5]_i_5_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \delay_high_cntr[2]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \delay_high_cntr[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \delay_high_cntr[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \delay_high_cntr[5]_i_2\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \delay_low_cntr[11]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \delay_low_cntr[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \delay_low_cntr[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \delay_low_cntr[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \delay_low_cntr[5]_i_2\ : label is "soft_lutpair2";
...
\delay_high_cntr[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"8B"
    )
        port map (
...
\delay_high_cntr[5]_i_29\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      ...
      I1 => bit_cntr_reg(0),
      I2 => \GRB_reg_n_0_[7]\,
      O => \delay_high_cntr[5]_i_29_n_0\
    );
\delay_high_cntr[5]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"B8BBB888"
    )
        port map (
      I0 => \delay_high_cntr_reg[5]_i_4_n_0\,
      I1 => \delay_high_cntr_reg[5]_i_5_n_4\,
      I2 => \delay_high_cntr_reg[5]_i_6_n_0\,
      I3 => \delay_high_cntr_reg[5]_i_5_n_5\,
      I4 => \delay_high_cntr_reg[5]_i_7_n_0\,
...
\delay_high_cntr_reg[5]_i_14\: unisim.vcomponents.MUXF7
     port map (
      I0 => \delay_high_cntr[5]_i_22_n_0\,
      I1 => \delay_high_cntr[5]_i_23_n_0\,
      O => \delay_high_cntr_reg[5]_i_14_n_0\,
      S => \delay_high_cntr_reg[5]_i_5_n_7\
    );
\delay_high_cntr_reg[5]_i_15\: unisim.vcomponents.MUXF7
     port map (
      I0 => \delay_high_cntr[5]_i_24_n_0\,
      I1 => \delay_high_cntr[5]_i_25_n_0\,
      O => \delay_high_cntr_reg[5]_i_15_n_0\,
      S => \delay_high_cntr_reg[5]_i_5_n_7\
    );
\delay_high_cntr_reg[5]_i_16\: unisim.vcomponents.MUXF7
     port map (
      I0 => \delay_high_cntr[5]_i_26_n_0\,
      I1 => \delay_high_cntr[5]_i_27_n_0\,
      O => \delay_high_cntr_reg[5]_i_16_n_0\,
      S => \delay_high_cntr_reg[5]_i_5_n_7\
    );
\delay_high_cntr_reg[5]_i_17\: unisim.vcomponents.MUXF7
     port map (
      I0 => \delay_high_cntr[5]_i_28_n_0\,
      I1 => \delay_high_cntr[5]_i_29_n_0\,
      O => \delay_high_cntr_reg[5]_i_17_n_0\,
      S => \delay_high_cntr_reg[5]_i_5_n_7\
    );
\delay_high_cntr_reg[5]_i_4\: unisim.vcomponents.MUXF8
     port map (
      I0 => \delay_high_cntr_reg[5]_i_8_n_0\,
      I1 => \delay_high_cntr_reg[5]_i_9_n_0\,
      O => \delay_high_cntr_reg[5]_i_4_n_0\,
      S => \delay_high_cntr_reg[5]_i_5_n_6\
    );
\delay_high_cntr_reg[5]_i_5\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \NLW_delay_high_cntr_reg[5]_i_5_CO_UNCONNECTED\(3),
      CO(2) => \delay_high_cntr_reg[5]_i_5_n_1\,
      CO(1) => \delay_high_cntr_reg[5]_i_5_n_2\,
      CO(0) => \delay_high_cntr_reg[5]_i_5_n_3\,
      CYINIT => bit_cntr_reg(0),
      DI(3) => '0',
      DI(2 downto 0) => bit_cntr_reg(3 downto 1),
      O(3) => \delay_high_cntr_reg[5]_i_5_n_4\,
      O(2) => \delay_high_cntr_reg[5]_i_5_n_5\,
      O(1) => \delay_high_cntr_reg[5]_i_5_n_6\,
      O(0) => \delay_high_cntr_reg[5]_i_5_n_7\,
      S(3) => \delay_high_cntr[5]_i_10_n_0\,
      S(2) => \delay_high_cntr[5]_i_11_n_0\,
      S(1) => \delay_high_cntr[5]_i_12_n_0\,
      S(0) => \delay_high_cntr[5]_i_13_n_0\
    );
\delay_high_cntr_reg[5]_i_6\: unisim.vcomponents.MUXF8
     port map (
      I0 => \delay_high_cntr_reg[5]_i_14_n_0\,
      I1 => \delay_high_cntr_reg[5]_i_15_n_0\,
      O => \delay_high_cntr_reg[5]_i_6_n_0\,
      S => \delay_high_cntr_reg[5]_i_5_n_6\
    );
\delay_high_cntr_reg[5]_i_7\: unisim.vcomponents.MUXF8
     port map (
      I0 => \delay_high_cntr_reg[5]_i_16_n_0\,
      I1 => \delay_high_cntr_reg[5]_i_17_n_0\,
      O => \delay_high_cntr_reg[5]_i_7_n_0\,
      S => \delay_high_cntr_reg[5]_i_5_n_6\
    );
\delay_high_cntr_reg[5]_i_8\: unisim.vcomponents.MUXF7
     port map (
      I0 => \delay_high_cntr[5]_i_18_n_0\,
      I1 => \delay_high_cntr[5]_i_19_n_0\,
      O => \delay_high_cntr_reg[5]_i_8_n_0\,
      S => \delay_high_cntr_reg[5]_i_5_n_7\
    );
\delay_high_cntr_reg[5]_i_9\: unisim.vcomponents.MUXF7
     port map (
      I0 => \delay_high_cntr[5]_i_20_n_0\,
      I1 => \delay_high_cntr[5]_i_21_n_0\,
...
\delay_low_cntr[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AC"
    )
        port map (
