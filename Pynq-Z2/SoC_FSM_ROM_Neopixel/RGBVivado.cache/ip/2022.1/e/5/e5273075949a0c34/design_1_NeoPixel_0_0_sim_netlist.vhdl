...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_NeoPixel is
  ...
  signal delay_low_cntr : STD_LOGIC_VECTOR ( 6 downto 1 );
  ...
  attribute SOFT_HLUTNM of \delay_low_cntr[10]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \delay_low_cntr[11]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \delay_low_cntr[12]_i_2\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \delay_low_cntr[4]_i_1\ : label is "soft_lutpair3";
...
\delay_low_cntr[11]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
