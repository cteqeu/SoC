...
namespace eval ::optrace {
  variable script "C:/devWorks/RGB/RGBVivado/RGBVivado.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet C:/devWorks/RGB/RGBVivado/RGBVivado.runs/synth_1/design_1_wrapper.dcp
