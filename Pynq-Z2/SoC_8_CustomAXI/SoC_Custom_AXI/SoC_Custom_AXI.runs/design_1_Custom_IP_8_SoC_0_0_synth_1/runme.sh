...
HD_PWD='C:/devWorks/8_SoC_AXI/SoC_Custom_AXI/SoC_Custom_AXI.runs/design_1_Custom_IP_8_SoC_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Custom_IP_8_SoC_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Custom_IP_8_SoC_0_0.tcl
